        ...
        <>
            <div className='sticky top-0 z-50 drop-shadow'>
                <nav className="bg-white dark:bg-neutral-900">
                    <div className="flex flex-wrap justify-between items-center mx-auto max-w-screen-xl px-4 md:px-6 py-2">
                        ...
                        <div className="flex items-center">
                            <Search />
                            <Account />
                            <Link to="/cart" className="flex relative space-x-4 ml-4">
